...
function runCypressCI() {
  ...
  execSync(
    "COMMIT_INFO_MESSAGE=$(git show -s --format=%s) docker-compose run cypress ./node_modules/.bin/percy exec -t 300 -- ./node_modules/.bin/cypress run --record --spec client/cypress/integration/user/login_spec.js",
    { stdio: "inherit" }
  );
}
